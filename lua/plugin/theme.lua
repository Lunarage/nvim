local hi_overrides = function(colors)
  return {
    ...
    BufferLineBackground = { fg = nil, bg = colors.base },
    BufferLineSeparator = { fg = colors.mantle, bg = colors.base },
    BufferLineSeparatorSelected = { fg = colors.mantle, bg = colors.base },
    BufferLineSeparatorVisible = { fg = colors.mantle, bg = colors.base },
